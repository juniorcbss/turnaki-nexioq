...
aws dynamodb put-item \
  ...
  --item '{
    ...
    "status": {"S": "active"},
    "createdAt": {"S": "'"$NOW"'"}
  }' 2>&1 | grep -v "An error occurred" || echo "✅ Tenant creado"
...
aws dynamodb put-item \
  ...
  --item '{
    ...
    "price": {"N": "50000"},
    "createdAt": {"S": "'"$NOW"'"}
  }' 2>&1 | grep -v "An error occurred" || echo "  ✅ Limpieza Dental"
...
aws dynamodb put-item \
  ...
  --item '{
    ...
    "price": {"N": "80000"},
    "createdAt": {"S": "'"$NOW"'"}
  }' 2>&1 | grep -v "An error occurred" || echo "  ✅ Extracción Simple"
...
aws dynamodb put-item \
  ...
  --item '{
    ...
    "price": {"N": "120000"},
    "createdAt": {"S": "'"$NOW"'"}
  }' 2>&1 | grep -v "An error occurred" || echo "  ✅ Ortodoncia - Consulta"
...
aws dynamodb put-item \
  ...
  --item '{
    ...
    "status": {"S": "active"},
    "createdAt": {"S": "'"$NOW"'"}
  }' 2>&1 | grep -v "An error occurred" || echo "✅ Profesional creado"
